# STM32F103C8T6 gateway source layout
...
- `BoardSupport.*` — STM32F103C8 clocks, GPIO, SPI, timers and low-level board services.
...
- `Telemetry.*` — host telemetry model and legacy wire-protocol parser.
