...
#define USBD_PRODUCT_STRING "BLUEPILL_F103 BOOT CDC"
#elif defined(BOARD_F401CD)
#define USBD_PRODUCT_STRING "BLACKPILL_F401CD BOOT CDC"
#elif defined(BOARD_F411CC)
#define USBD_PRODUCT_STRING "BLACKPILL_F411CC BOOT CDC"
#else
