...
need('default_envs = f103_256k_usbboot' in pio and '[env:f103_256k_usbboot]' in pio and '[env:bluepill_f103c8]' in pio and '[env:blackpill_f411ce_romdfu]' in pio and 'extends = env:blackpill_f411ce_v2' in pio, 'F103RC is production default while F103C8 and F411 ROM-DFU recovery remain available')
